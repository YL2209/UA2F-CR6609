...
# 修改主机名字（不能纯数字或者使用中文）
sed -i 's/OpenWrt/NaoKuo/g' package/base-files/files/bin/config_generate
...
sed -i 's/OpenWrt/NaoKuo/g' include/u-boot.mk
sed -i 's/iStoreOS/NaoKuo/g' include/version.mk
